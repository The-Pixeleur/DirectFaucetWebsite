...
<html lang="en">
<head>
	<title>DCF - Privacy Policy</title>
	...
	<div class="bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen py-12">
		<div class="container mx-auto px-4 max-w-4xl">
			<div class="text-center mb-12">
				<h1 class="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">Privacy Policy</h1>
				<p class="text-gray-400">Last updated: <script>document.write(new Date().toLocaleDateString())</script></p>
			</div>
			...
			<div class="space-y-8">
				...
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					...
					<p class="text-gray-400">Direct Crypto Faucet ("we", "us", or "our") operates directfaucet.cc (the "Site") as a directory service that lists cryptocurrency faucets. We prioritize your privacy and want to be transparent about our practices.</p>
				</div>

				<!-- No Data Collection -->
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					<h2 class="text-2xl font-bold mb-4">No Personal Data Collection</h2>
					<p class="text-gray-400 mb-4">We do not collect, store, or process any personal information. Our site functions as a simple directory that:</p>
					<ul class="list-disc list-inside text-gray-400 space-y-2">
						<li>Lists available cryptocurrency faucets</li>
						<li>Provides links to external faucet websites</li>
						<li>Displays cryptocurrency prices via CoinGecko's public API</li>
						<li>Does not require any user registration or login</li>
						<li>Does not track individual user behavior</li>
					</ul>
				</div>

				<!-- External Links -->
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					<h2 class="text-2xl font-bold mb-4">External Websites</h2>
					<p class="text-gray-400">Our site contains links to external faucet websites. Please note that:</p>
					<ul class="list-disc list-inside text-gray-400 space-y-2">
						<li>We are not responsible for the privacy practices of these external sites</li>
						<li>Each faucet website has its own privacy policy and terms of service</li>
						<li>You should review the privacy policies of any faucet sites you visit</li>
						<li>Any information you provide to external faucets is subject to their policies</li>
					</ul>
				</div>
				...
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					...
					<p class="text-gray-400 mb-4">We use minimal third-party services:</p>
					<ul class="list-disc list-inside text-gray-400 space-y-2">
						<li>CoinGecko API: Used to display current cryptocurrency prices</li>
						<li>Google Analytics: Basic anonymous traffic statistics</li>
					</ul>
					<p class="text-gray-400 mt-4">These services may use cookies or collect anonymous usage data. You can control this through your browser settings.</p>
				</div>

				<!-- Contact Information -->
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					<h2 class="text-2xl font-bold mb-4">Contact Information</h2>
					<p class="text-gray-400">If you contact us via email at support@directfaucet.cc:</p>
					<ul class="list-disc list-inside text-gray-400 space-y-2">
						<li>We only use your email address to respond to your inquiry</li>
						<li>We do not store email addresses for marketing purposes</li>
				...
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					...
					<p class="text-gray-400">We may update this Privacy Policy to reflect changes in our practices or for legal reasons. Any updates will be posted on this page.</p>
				</div>

				<!-- Contact -->
				<div class="bg-blue-900 bg-opacity-50 rounded-xl p-6">
					<h2 class="text-2xl font-bold mb-4">Contact Us</h2>
					<p class="text-gray-400 mb-4">If you have any questions about this Privacy Policy, please contact us at:</p>
					<a href="mailto:support@directfaucet.cc" class="text-blue-400 hover:underline">support@directfaucet.cc</a>
				</div>
			</div>
		</div>
	</div>
