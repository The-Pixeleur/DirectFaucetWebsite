...
<html lang="en">
<head>
	<title>DCF - Terms of Service</title>
	...
	<div class="bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen py-12">
		<div class="container mx-auto px-4 max-w-4xl">
			<div class="text-center mb-12">
				<h1 class="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">Terms of Service</h1>
			...
			<div class="space-y-8">
				...
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					...
					<p class="text-gray-400">These Terms of Service ("Terms") govern your use of directfaucet.cc (the "Site"). Direct Crypto Faucet operates as a directory service that lists cryptocurrency faucets and provides links to external faucet websites. By using our Site, you agree to these Terms.</p>
				</div>

				<!-- Service Description -->
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					<h2 class="text-2xl font-bold mb-4">Service Description</h2>
					<p class="text-gray-400 mb-4">Our service consists of:</p>
					<ul class="list-disc list-inside text-gray-400 space-y-2">
						<li>Maintaining a curated list of cryptocurrency faucets</li>
						<li>Providing links to external faucet websites</li>
						<li>Displaying cryptocurrency prices via CoinGecko's API</li>
						<li>Offering informational content about crypto faucets</li>
					</ul>
				</div>
				...
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					...
					<p class="text-gray-400 mb-4">Please understand that:</p>
					<ul class="list-disc list-inside text-gray-400 space-y-2">
						<li>We are not responsible for external faucet websites</li>
						<li>Each faucet has its own terms of service and rules</li>
						<li>We do not guarantee faucet payments or availability</li>
						<li>We are not affiliated with the listed faucets</li>
						<li>Use external faucets at your own discretion and risk</li>
					</ul>
				</div>
				...
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					...
					<p class="text-gray-400 mb-4">When using our Site, you agree to:</p>
					<ul class="list-disc list-inside text-gray-400 space-y-2">
						<li>Use the Site for lawful purposes only</li>
						<li>Not attempt to manipulate or abuse our service</li>
						<li>Not use automated tools or bots on our Site</li>
						<li>Report any broken or suspicious links</li>
						<li>Follow each faucet's individual terms of service</li>
					</ul>
				</div>
				...
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					...
					<p class="text-gray-400 mb-4">Our service is provided "as is" and "as available". We:</p>
					<ul class="list-disc list-inside text-gray-400 space-y-2">
						<li>Do not guarantee faucet reliability or payments</li>
						<li>Are not responsible for losses from using external faucets</li>
						<li>Do not guarantee cryptocurrency price accuracy</li>
						<li>May update or modify our service at any time</li>
				...
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					...
					<p class="text-gray-400">The Site's content, features, and functionality are owned by Direct Crypto Faucet and are protected by copyright laws. Cryptocurrency prices are provided by CoinGecko's public API.</p>
				</div>

				<!-- Changes to Terms -->
				<div class="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
					<h2 class="text-2xl font-bold mb-4">Changes to Terms</h2>
					<p class="text-gray-400">We may update these Terms at any time. Continued use of the Site after changes constitutes acceptance of the updated Terms.</p>
				</div>

				<!-- Contact -->
				<div class="bg-blue-900 bg-opacity-50 rounded-xl p-6">
					<h2 class="text-2xl font-bold mb-4">Contact Us</h2>
					<p class="text-gray-400 mb-4">If you have any questions about these Terms, please contact us at:</p>
